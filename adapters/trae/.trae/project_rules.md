...
- Read `.trae/references/requirement-patterns-zh.md` when drafting or rewriting Chinese requirements.
- Read `.trae/references/requirement-patterns-en.md` when drafting or rewriting English requirements.
- Read `.trae/references/automotive-context.md` when the work involves automotive safety, diagnostics, cybersecurity, interfaces, operating states, suppliers, or verification context.
