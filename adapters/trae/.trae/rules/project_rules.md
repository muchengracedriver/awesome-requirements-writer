---
alwaysApply: false
description: Use when drafting, rewriting, reviewing, decomposing, or formalizing technical product requirements from engineering notes, customer inputs, standards, diagnostics, interfaces, or test expectations.
---

# Awesome Requirements Writer for Trae
...
- Read `.trae/rules/references/requirement-patterns-zh.md` when drafting or rewriting Chinese requirements.
- Read `.trae/rules/references/requirement-patterns-en.md` when drafting or rewriting English requirements.
- Read `.trae/rules/references/automotive-context.md` when the work involves automotive safety, diagnostics, cybersecurity, interfaces, operating states, suppliers, or verification context.
